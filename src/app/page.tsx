...
const Portfolio = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <section
        id="home"
        className="min-h-screen flex items-center justify-center px-4 pt-8"
      >
        <div className="max-w-4xl mx-auto text-center">
          <Image
            src={AndreBordignon}
            alt="André Bordignon"
            className="w-38 h-38 flex items-center justify-center mx-auto object-fit mb-8 rounded-full"
          />
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            {displayedText}
            <span className="animate-pulse-0-slow text-pink-500">|</span>
          </h1>
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
            ...
            Especializado em React, React Native, Node.js e desenvolvimento de
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Engenheiro de Software com 9+ anos de experiência em
                desenvolvimento web e mobile, especializado em React e React
                Native. Atuação em projetos de alta complexidade, com foco em
                performance, experiência do usuário e liderança técnica.
              </p>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Especializo-me em desenvolvimento full-stack, com foco especial
                em React para frontend e Node.js para backend. Adoro trabalhar
                em projetos desafiadores que me permitam aprender e crescer
                continuamente.
              </p>
            </div>
      ...
      <section id="blog" className="px-4 bg-blue-900/25">
        <Blog />
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-gray-800 rounded-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-gray-700 hover:border-gray-600"
              >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              ...
              interessantes. Vamos conversar sobre como posso ajudar com seu
              próximo projeto!
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-6 text-center">
                ...
                <button
                  ...
                  className="w-full cursor-pointer px-8 py-3 mt-6 bg-gradient-to-r  from-blue-600 to-purple-600 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold"
                >
